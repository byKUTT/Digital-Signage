...
class DS_Portal {
	...
	public function redirect_legacy_admin() { if ( ! current_user_can( DS_Roles::CAP ) || current_user_can( 'manage_options' ) || wp_doing_ajax() ) { return; } $page = sanitize_key( wp_unslash( $_GET['page'] ?? '' ) ); if ( 'digital-signage' === $page || 0 === strpos( $page, 'ds-' ) ) { wp_safe_redirect( self::url() ); exit; } }
