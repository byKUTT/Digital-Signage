...
class DS_Icons {
	...
	public static function icon( $name, $class = '' ) {
		$paths = array(
			...
			'infinite_scroll' => '<rect x="2" y="7" width="6" height="10" rx="1"/><rect x="9" y="4" width="6" height="16" rx="1"/><rect x="16" y="7" width="6" height="10" rx="1"/>',
	...
	public static function type_label( $type ) {
		$labels = array(
			...
			'infinite_scroll' => __( 'Infinite Scroll', 'digital-signage' ),
		);
