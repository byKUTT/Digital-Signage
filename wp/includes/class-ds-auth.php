...
class DS_Auth {
	...
	const LEGACY_LOGIN   = '/signage-login/';
	const LEGACY_REGISTER = '/signage-register/';
	...
	public function render() {
		...
		if ( in_array( $path, array( untrailingslashit( self::LEGACY_LOGIN ), untrailingslashit( self::LEGACY_REGISTER ) ), true ) ) { wp_safe_redirect( 'login' === $mode ? self::login_url() : self::register_url(), 301 ); exit; }
