...
<body class="ds-player-body">
	...
	<div id="ds-no-channel" class="ds-no-channel" hidden>
		<header class="ds-no-channel-header"><span class="ds-no-channel-brand"><img src="<?php echo esc_url( DS_PLUGIN_URL . 'public/images/screens-bykutt-mark.svg' ); ?>" alt=""><b>Screens<small>byKUTT</small></b></span><span>byKUTT</span></header>
		<div class="ds-no-channel-card">
			<div class="ds-no-channel-copy">
				<span class="ds-no-channel-kicker"><?php esc_html_e( 'Reconnect this display', 'digital-signage' ); ?></span>
				<h1><?php esc_html_e( 'Ready for a channel.', 'digital-signage' ); ?></h1>
				<p><?php esc_html_e( 'Scan the code, sign in, and choose what this screen should play.', 'digital-signage' ); ?></p>
