...
<div class="ds-app-wrap">
	...
	<div class="ds-two-col">
		<div class="ds-panel">
			...
			<code class="ds-code-block"><?php echo esc_html( home_url( '/play/{random-token}/' ) ); ?></code>
			...
			<p><?php esc_html_e( 'For an Ubuntu PC, install the controller package instead. It detects every connected display and shows one pairing code while creating an independent Screen for each output.', 'digital-signage' ); ?></p>
