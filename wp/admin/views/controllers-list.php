...
<div class="ds-app-wrap">
	<div class="ds-app-header">
		<div>
			...
			<p class="ds-app-subtitle"><?php esc_html_e( 'Ubuntu computers that drive one or more independently assigned displays.', 'digital-signage' ); ?></p>
		</div>
	...
	<?php else : ?>
		<div class="ds-empty-state">
			...
			<p><?php esc_html_e( 'Install the Ubuntu controller package. A code will appear on every connected monitor; enter that code on the Pairing page.', 'digital-signage' ); ?></p>
		</div>
	<?php endif; ?>
</div>
