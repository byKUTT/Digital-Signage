...
For most people, [`../pi/install-kiosk.sh`](../pi/)
...
4. Pair it in wp-admin. It's now remotely manageable from the Screen's
   Device panel — see the main [`pi/README.md`](../pi/README.md).
...
- `stage-ds-kiosk/00-install-kiosk/files/` — copied verbatim from
  `../pi/` by the GitHub Actions workflow (and by Option B's
