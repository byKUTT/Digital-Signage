...
- A channel owns Infinite Slider portrait spacing, landscape spacing, speed, and image border radius. The player uses the actual rendered zone dimensions to choose its direction.
