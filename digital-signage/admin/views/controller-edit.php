	...
	<details class="ds-disclosure">
		...
		<div class="ds-disclosure-body">
			...
			<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
				...
				<div class="ds-settings-grid"><label class="ds-field"><span><input type="checkbox" name="enabled" value="1" <?php checked( ! empty( $schedule['enabled'] ) ); ?> /> <?php esc_html_e( 'Enable display schedule', 'digital-signage' ); ?></span></label><div class="ds-field"><label for="wake_time"><?php esc_html_e( 'Turn on', 'digital-signage' ); ?></label><input class="ds-input" type="time" id="wake_time" name="wake_time" value="<?php echo esc_attr( $schedule['wake_time'] ); ?>" /></div><div class="ds-field"><label for="sleep_time"><?php esc_html_e( 'Turn off', 'digital-signage' ); ?></label><input class="ds-input" type="time" id="sleep_time" name="sleep_time" value="<?php echo esc_attr( $schedule['sleep_time'] ); ?>" /></div><div class="ds-field"><label for="timezone"><?php esc_html_e( 'Time zone', 'digital-signage' ); ?></label><select class="ds-input" id="timezone" name="timezone"><?php echo wp_timezone_choice( $schedule['timezone'], get_user_locale() ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></select></div></div>
